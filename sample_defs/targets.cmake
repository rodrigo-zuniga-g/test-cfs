...
# COMMS RZ1<->RZ2: el buscador de módulos de cFE (mission_build.cmake)
# ubica cada entrada de APPLIST como una CARPETA dentro de apps/, no como
# el nombre del módulo pasado a add_cfe_app(). Como las carpetas se llaman
# apps/sample_app_rz1 y apps/sample_app_rz2 (el add_cfe_app(rz1_app ...)
# de adentro define el nombre del binario, no el de la carpeta), acá hay
# que listar "sample_app_rz1" y "sample_app_rz2". Además hace falta
# agregarlas a cpu1_cfe_es_startup.scr (con el nombre de módulo rz1_app/
# rz2_app) para que se carguen en tiempo de ejecución.
# NOTA (no relacionado con rz1/rz2): "SIMULATION=native" en el comando de
# prep solo elige el compilador; el fileset de configuración (osconfig/
# pspconfig) sigue siendo "default" a menos que se liste "native" acá.
# Sin esto, correr como usuario normal (sin permisos de prioridad RT)
# hace que cFE aborte con "Could not setschedparam ... Operation not
# permitted" al arrancar. Con "native" se activa
